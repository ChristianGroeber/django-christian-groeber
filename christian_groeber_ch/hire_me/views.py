...
def index(request):
    ...
    for experience in exp:
        experiences.append(ExperienceObject(experience.title, experience.date_from, description=experience.description, date_until=experience.date_until))
    for element in elements:
        experiences.append(ExperienceObject(element.title, element.date_started, description=element.description, date_until=element.date_finished))
    print(experiences)
...
class ExperienceObject:
    def __init__(self, title, date_from, description=None, date_until=None):
        self.title = title
